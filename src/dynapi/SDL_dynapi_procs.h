...
SDL_DYNAPI_PROC(void,SDL_GpuPushVertexUniformData,(SDL_GpuCommandBuffer *a, int b, const void *c, Uint32 d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuPushFragmentUniformData,(SDL_GpuCommandBuffer *a, int b, const void *c, Uint32 d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuPushComputeUniformData,(SDL_GpuCommandBuffer *a, int b, const void *c, Uint32 d),(a,b,c,d),)
SDL_DYNAPI_PROC(SDL_GpuRenderPass*,SDL_GpuBeginRenderPass,(SDL_GpuCommandBuffer *a, SDL_GpuColorAttachmentInfo *b, int c, SDL_GpuDepthStencilAttachmentInfo *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(void,SDL_GpuBindVertexBuffers,(SDL_GpuRenderPass *a, int b, SDL_GpuBufferBinding *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindIndexBuffer,(SDL_GpuRenderPass *a, SDL_GpuBufferBinding *b, SDL_GpuIndexElementSize c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_GpuBindVertexSamplers,(SDL_GpuRenderPass *a, int b, SDL_GpuTextureSamplerBinding *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindVertexStorageTextures,(SDL_GpuRenderPass *a, int b, SDL_GpuTextureSlice *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindVertexStorageBuffers,(SDL_GpuRenderPass *a, int b, SDL_GpuBuffer **c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindFragmentSamplers,(SDL_GpuRenderPass *a, int b, SDL_GpuTextureSamplerBinding *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindFragmentStorageTextures,(SDL_GpuRenderPass *a, int b, SDL_GpuTextureSlice *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindFragmentStorageBuffers,(SDL_GpuRenderPass *a, int b, SDL_GpuBuffer **c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuDrawIndexedPrimitives,(SDL_GpuRenderPass *a, int b, int c, int d, int e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GpuDrawPrimitives,(SDL_GpuRenderPass *a, int b, int c),(a,b,c),)
SDL_DYNAPI_PROC(void,SDL_GpuDrawPrimitivesIndirect,(SDL_GpuRenderPass *a, SDL_GpuBuffer *b, int c, int d, int e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GpuDrawIndexedPrimitivesIndirect,(SDL_GpuRenderPass *a, SDL_GpuBuffer *b, int c, int d, int e),(a,b,c,d,e),)
SDL_DYNAPI_PROC(void,SDL_GpuEndRenderPass,(SDL_GpuRenderPass *a),(a),)
SDL_DYNAPI_PROC(SDL_GpuComputePass*,SDL_GpuBeginComputePass,(SDL_GpuCommandBuffer *a, SDL_GpuStorageTextureReadWriteBinding *b, int c, SDL_GpuStorageBufferReadWriteBinding *d, int e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(void,SDL_GpuBindComputePipeline,(SDL_GpuComputePass *a, SDL_GpuComputePipeline *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuBindComputeStorageTextures,(SDL_GpuComputePass *a, int b, SDL_GpuTextureSlice *c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuBindComputeStorageBuffers,(SDL_GpuComputePass *a, int b, SDL_GpuBuffer **c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuDispatchCompute,(SDL_GpuComputePass *a, int b, int c, int d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuDispatchComputeIndirect,(SDL_GpuComputePass *a, SDL_GpuBuffer *b, int c),(a,b,c),)
...
SDL_DYNAPI_PROC(void,SDL_GpuCopyTextureToTexture,(SDL_GpuCopyPass *a, SDL_GpuTextureLocation *b, SDL_GpuTextureLocation *c, int d, int e, int f, SDL_bool g),(a,b,c,d,e,f,g),)
...
SDL_DYNAPI_PROC(SDL_GpuTexture*,SDL_GpuAcquireSwapchainTexture,(SDL_GpuCommandBuffer *a, SDL_Window *b, int *c, int *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(void,SDL_GpuWaitForFences,(SDL_GpuDevice *a, SDL_bool b, SDL_GpuFence **c, int d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(int,SDL_GpuTextureFormatTexelBlockSize,(SDL_GpuTextureFormat a),(a),return)
